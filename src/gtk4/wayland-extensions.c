...
#include "keyboard-shortcuts-inhibit-unstable-v1-client-protocol-gtk4.h"
                                                            ...
                                                            wl_fixed_t, wl_fixed_t, wl_fixed_t, wl_fixed_t))
{
    ...
    if (relative_pointer == NULL) {
        struct zwp_relative_pointer_manager_v1 *relative_pointer_manager;
        GdkSurface *surface = gtk_native_get_surface(gtk_widget_get_native(widget));        struct wl_pointer *pointer;
